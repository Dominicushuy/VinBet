...
export async function GET(request: NextRequest) {
  try {
    ...
    const fromDate = validatedParams.fromDate
      ? new Date(validatedParams.fromDate).toISOString()
      : null
    const toDate = validatedParams.toDate
      ? new Date(validatedParams.toDate).toISOString()
      : null
    ...
    const jackpotOnly = validatedParams.jackpotOnly
