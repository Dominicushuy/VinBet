...
import { 
  ArrowDownRight, ArrowUpRight, ChevronRight, Clock, 
  DollarSign, Download, TrendingUp, Wallet 
} from 'lucide-react';
    ...
    <div className="space-y-6">
          ...
          <CardContent>
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex items-center text-sm text-muted-foreground">
                ...
                <span className="text-green-500 font-medium">+{formatCurrency(transactionStats?.[0]?.total_win || 0)}</span>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Biểu đồ giao dịch trong 30 ngày qua
          </CardDescription>
        </CardHeader>
        <CardContent>
