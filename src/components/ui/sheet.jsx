...
const SheetTitle = React.forwardRef((props, ref) => {
  const { className, ...rest } = props
  return <SheetPrimitive.Title ref={ref} className={cn('text-lg font-semibold text-foreground', className)} {...rest} />
})
SheetTitle.displayName = SheetPrimitive.Title.displayName

const SheetDescription = React.forwardRef((props, ref) => {
  const { className, ...rest } = props
  return <SheetPrimitive.Description ref={ref} className={cn('text-sm text-muted-foreground', className)} {...rest} />
})
