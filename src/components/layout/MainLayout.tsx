        ...
        <div className='max-w-screen-2xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6'>
          <div className='grid grid-cols-1 gap-6 md:grid-cols-[240px_1fr]'>
            ...
            <main className='min-w-0 overflow-hidden'>
              <div className='bg-background rounded-xl p-4 sm:p-6 shadow-sm border'>
                {children}
              </div>
            </main>
          </div>
        ...
        <div className='max-w-screen-2xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8'>
          <div className='grid grid-cols-1 gap-8 md:grid-cols-12'>
            ...
            <div className='flex flex-col gap-4 md:col-span-4'>
              ...
              <p className='text-sm text-muted-foreground'>
                Nền tảng cá cược trực tuyến hàng đầu Việt Nam, cung cấp trải
                nghiệm đặt cược an toàn và công bằng.
              </p>
          ...
          <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
            ...
            <p className='text-sm text-muted-foreground'>
              © 2024 VinBet. Tất cả các quyền được bảo lưu.
            </p>
          </div>
        </div>
      </footer>
