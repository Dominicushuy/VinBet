// src/components/referrals/ReferralCodeCard.tsx
"use client";
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Mã giới thiệu của bạn</CardTitle>
        <CardDescription>
          Chia sẻ mã này để nhận thưởng khi bạn bè đăng ký và nạp tiền
        </CardDescription>
      </CardHeader>
        ...
        <div className="flex items-center space-x-2">
          <div className="grid flex-1 gap-2">
            ...
            <div className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm truncate">
              <span className="flex-1 leading-loose overflow-hidden text-ellipsis">
                {data?.shareUrl}
              </span>
            </div>
          </div>
