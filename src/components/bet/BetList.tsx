// src/components/bet/BetList.tsx
"use client";
...
export function BetList({
  ...
  const bets = data?.bets || initialBets || [];
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Bạn chưa đặt cược nào {gameRoundId ? "trong lượt này" : ""}
          </CardDescription>
        </CardHeader>
...
interface BetTableProps {
  ...
  getBetStatusBadge: (status: string) => JSX.Element;
}
