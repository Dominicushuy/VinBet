...
import { Clock, Trophy, Users, ExternalLink, Calendar, Timer, Ban } from 'lucide-react'
          ...
          <div className='p-4 flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex-1 flex flex-col justify-center min-w-0'>
              ...
              <div className='flex items-center justify-between mb-1'>
                <div className='text-sm font-medium'>Lượt chơi #{game.id.substring(0, 8)}</div>
                {getStatusBadge()}
              </div>
              ...
              <div className='flex items-center text-sm gap-1 text-muted-foreground mb-1'>
                ...
                <span className={cn('font-medium', isLive ? 'text-green-600 dark:text-green-400' : '')}>
                  {timeLeft}
                </span>
              </div>
              ...
              <div className='flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground'>
                ...
                {game.bets_count > 0 && (
                  <div className='flex items-center gap-1'>
                    ...
                    <span>{game.bets_count} người chơi</span>
                  </div>
                )}
              </div>
            </div>
