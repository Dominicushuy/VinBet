...
export default function GameLeaderboard({
  ...
  if (
    error ||
    (tab === 'bets' && topBets.length === 0) ||
    (tab === 'winners' && topWinners.length === 0)
  ) {
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Những người đặt cược nhiều nhất và thắng lớn nhất
          </CardDescription>
        </CardHeader>
  ...
  // Generate icon based on position
                          ...
                          <TableCell>
                            <div className='flex items-center gap-2'>
                              <Avatar className='h-6 w-6'>
                                <AvatarImage
                                  src={bet.profile.avatar_url || ''}
                                />
                                <AvatarFallback>
                                  {(bet.profile.display_name ||
                                    bet.profile.username ||
                                    'U')[0].toUpperCase()}
                                </AvatarFallback>
                              </Avatar>
