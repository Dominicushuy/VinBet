// src/components/finance/TransactionHistoryTable.tsx
"use client";
...
export function TransactionHistoryTable({
  ...
  const transactions = data?.transactions || initialData;
    ...
    return (
      <div className="p-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Hiện tại bạn chưa có giao dịch nào hoặc không có giao dịch nào phù hợp
          với bộ lọc.
        </p>
      </div>
    );
      ...
      {pagination.totalPages > 1 && (
        <div className="flex items-center justify-between px-2 py-4">
          <div className="text-sm text-muted-foreground">
            ...
            trong {pagination.total} giao dịch
          </div>
          <Pagination
