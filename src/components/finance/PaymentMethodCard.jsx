  ...
  return (
    <Card
      className={cn(
        ...
        selected ? 'border-primary shadow-sm' : 'border-muted hover:border-muted-foreground/20'
      )}
      onClick={onSelect}
    >
      {selected && (
      ...
      <CardContent className='p-4 flex flex-col items-center text-center'>
        ...
        <Label htmlFor={`payment-method-${method.id}`} className='font-medium text-base cursor-pointer'>
          {method.name}
        </Label>
