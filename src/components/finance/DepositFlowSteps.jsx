          ...
          <div className='space-y-4'>
            <div className='space-y-2'>
              ...
              <div className='flex justify-between'>
                <Label>Số tiền:</Label>
                <div className='flex items-center'>
                  <span className='font-medium text-primary'>{formatMoney(watchAmount)}</span>
                  <Button
                    variant='ghost'
                    size='icon'
                    className='h-6 w-6 ml-1'
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleStep1Submit)} className='space-y-6'>
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Số tiền tối thiểu: {formatMoney(config.min_deposit)}, tối đa: {formatMoney(config.max_deposit)}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className='pt-4 flex justify-end space-x-2'>
                <Button type='submit' disabled={createPaymentRequestMutation.isLoading}>
        ...
        {step === 2 && (
          <div className='space-y-6'>
            <div className='rounded-lg border bg-card p-6'>
              ...
              {getSelectedMethodDetails() && getSelectedMethodDetails().accounts.length > 1 && (
                <Tabs
                ...
                >
                  <TabsList className='grid w-full grid-cols-2'>
                    {getSelectedMethodDetails().accounts.map((account, index) => (
              ...
              {getSelectedMethodDetails()?.accounts.length === 1 && getPaymentInstructions()}
            </div>

            <div className='rounded-lg border bg-card p-6'>
              <h3 className='text-lg font-semibold mb-4'>Tải lên bằng chứng thanh toán</h3>
              {requestId && <PaymentProofUpload requestId={requestId} onUploadComplete={handleProofUploaded} />}
            </div>
          ...
          <div className='space-y-6 text-center py-6'>
            ...
            <div className='space-y-2'>
              ...
              <p className='text-muted-foreground'>
                Yêu cầu nạp tiền của bạn đã được gửi thành công. Vui lòng chờ admin xác nhận và tiền sẽ được cộng vào
