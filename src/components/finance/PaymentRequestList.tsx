// src/components/finance/PaymentRequestList.tsx
"use client";
...
export function PaymentRequestList({
  ...
  const paymentRequests =
    data?.paymentRequests || initialData?.paymentRequests || [];
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          <CardTitle>
            {type === "deposit" ? "Lịch sử nạp tiền" : "Lịch sử rút tiền"}
          </CardTitle>
          <CardDescription>
            Các yêu cầu {type === "deposit" ? "nạp" : "rút"} tiền của bạn
          </CardDescription>
        </div>
        <Button
          variant="outline"
