// src/components/finance/withdrawal-steps/Step3Success.jsx
'use client'
    ...
    <div className='space-y-6 text-center py-6'>
      ...
      <div className='space-y-2'>
        ...
        <p className='text-muted-foreground'>
          Yêu cầu rút tiền của bạn đã được gửi thành công. Vui lòng chờ admin xác nhận và tiền sẽ được chuyển vào tài
      ...
      <div className='bg-muted p-4 rounded-md my-6'>
        <div className='space-y-2'>
          <div className='flex justify-between'>
            ...
            <span className='font-medium'>{method?.name || 'Chưa xác định'}</span>
          </div>
          <div className='flex justify-between'>
