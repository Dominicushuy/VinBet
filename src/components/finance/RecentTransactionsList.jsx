...
import { ArrowDownLeft, ArrowUpRight, Clock, CreditCard, DollarSign, Award, Eye } from 'lucide-react'
                ...
                {selectedTransaction && (
                  <DialogContent className='sm:max-w-md'>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Thông tin chi tiết về giao dịch #{selectedTransaction.id.substring(0, 8)}
                      </DialogDescription>
                    </DialogHeader>
