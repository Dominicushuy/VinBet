...
import { Search, RefreshCw, UserCog, ArrowUpDown, AlertCircle } from 'lucide-react'
                    ...
                    <TableRow>
                      <TableHead>
                        <div className='flex items-center space-x-1'>
                          <span>Thông tin</span>
                          <ArrowUpDown className='h-3 w-3 cursor-pointer' onClick={() => handleSort('username')} />
                        </div>
                      </TableHead>
                      <TableHead>
                        <div className='flex items-center space-x-1'>
                          <span>Số dư</span>
                          <ArrowUpDown className='h-3 w-3 cursor-pointer' onClick={() => handleSort('balance')} />
                        </div>
                      </TableHead>
                      <TableHead>
                        <div className='flex items-center space-x-1'>
                          <span>Trạng thái</span>
                          <ArrowUpDown className='h-3 w-3 cursor-pointer' onClick={() => handleSort('is_admin')} />
                        </div>
                      </TableHead>
                      <TableHead>
                        <div className='flex items-center space-x-1'>
                          <span>Ngày đăng ký</span>
                          <ArrowUpDown className='h-3 w-3 cursor-pointer' onClick={() => handleSort('created_at')} />
                        </div>
                      </TableHead>
