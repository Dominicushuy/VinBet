...
export function GameRoundManagement() {
  ...
  return (
    <div className='space-y-6'>
              ...
              <form onSubmit={createForm.handleSubmit(handleCreateGameRound)} className='space-y-4'>
                ...
                <DialogFooter>
                  <Button type='submit' disabled={createGameRoundMutation.isLoading}>
                    {createGameRoundMutation.isLoading ? 'Đang tạo...' : 'Tạo lượt chơi'}
                  </Button>
                </DialogFooter>
              </form>
            </Form>
      ...
      <GameFilters status={status} fromDate={fromDate} toDate={toDate} onFilterChange={updateFilters} />
                  ...
                  <TableBody>
                    {gameRounds.map(game => (
                      <TableRow key={game.id}>
                        <TableCell className='font-medium'>{game.id.substring(0, 8)}...</TableCell>
              ...
              <form onSubmit={updateForm.handleSubmit(handleUpdateGameRound)} className='space-y-4'>
                ...
                <DialogFooter>
                  <Button type='submit' disabled={updateGameRoundMutation.isLoading}>
                    {updateGameRoundMutation.isLoading ? 'Đang cập nhật...' : 'Cập nhật'}
                  </Button>
                </DialogFooter>
              </form>
            </Form>
