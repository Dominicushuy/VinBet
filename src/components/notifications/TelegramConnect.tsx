...
export function TelegramConnect() {
  ...
  const { data: telegramStatus, isLoading: isStatusLoading } =
    useTelegramStatusQuery();
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Kết nối tài khoản Telegram để nhận thông báo nhanh chóng
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="pb-6">
        {isStatusLoading ? (
            ...
            <div className="space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground flex items-center">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          copyToClipboard(telegramStatus.telegram_id)
                        }
                      >
              ...
              <div className="mt-4 space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Bạn sẽ nhận được thông báo từ bot Telegram chính thức của
                  VinBet.
                </p>
              ...
              <Alert className="bg-amber-50 border-amber-200 mt-6">
                ...
                <AlertDescription className="text-amber-700">
                  Nếu bạn không nhận được thông báo, hãy đảm bảo rằng bạn chưa
                  chặn bot VinBet trên Telegram.
                </AlertDescription>
              </Alert>
            </div>
          </>
          ...
          <>
            ...
            <Tabs
              value={connectMethod}
              onValueChange={setConnectMethod}
              className="w-full"
            >
              ...
              <TabsContent value="chat" className="pt-6 space-y-6">
                <Steps>
                    ...
                    <div className="flex flex-col space-y-2 mt-2">
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() =>
                            copyToClipboard(`@${TELEGRAM_BOT_USERNAME}`)
                          }
                        >
                  ...
                  <Step
                    title="Gửi lệnh bắt đầu"
                    description="Gửi lệnh /start cho bot để nhận ID kết nối"
                  >
                    <div className="max-w-xs mx-auto mt-3">
                      <div className="border rounded-lg p-3 bg-muted/30">
                        <div className="text-xs text-muted-foreground mb-2">
                          Gửi tin nhắn này cho bot:
                        </div>
                        <div className="flex justify-between items-center">
                  ...
                  <Step
                    title="Nhập ID Telegram"
                    description="Nhập ID Telegram mà bot cung cấp cho bạn"
                  >
                    <div className="space-y-2 mt-2">
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          ...
                          disabled={
                            !telegramId.trim() || connectMutation.isLoading
                          }
                        >
                      ...
                      <p className="text-xs text-muted-foreground">
                        Bot sẽ cung cấp cho bạn một ID duy nhất để kết nối tài
                        khoản
                      </p>
                    </div>
                  </Step>
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Sau khi kết nối, bạn sẽ nhận được thông báo về các hoạt động
                    quan trọng trên tài khoản VinBet.
                  </AlertDescription>
                </Alert>
              </TabsContent>
              ...
              <TabsContent value="qr" className="pt-6 space-y-6">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-4 text-center max-w-xs">
                    Sử dụng ứng dụng Telegram trên điện thoại để quét mã QR và
                    bắt đầu kết nối
                  </p>

                  <div className="w-full mt-6 space-y-2">
                    <Label htmlFor="qr-telegram-id">
                      Nhập ID Telegram nhận được từ bot
                    </Label>
                    <div className="flex items-center gap-2">
                      <Input
                        id="qr-telegram-id"
                ...
                <Alert>
                  ...
                  <AlertDescription>
                    Bạn cần cài đặt ứng dụng Telegram trên điện thoại để quét mã
                    QR.
                  </AlertDescription>
                </Alert>
              </TabsContent>
