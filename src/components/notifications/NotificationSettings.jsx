  ...
  return (
    <Card>
          ...
          <TabsContent value='types' className='p-6 space-y-6'>
            <div className='space-y-6'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between'>
                  <div className='space-y-0.5'>
                    <Label className='text-base font-medium' htmlFor='bet_result_notifications'>
                      <div className='flex items-center'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={() => handleToggle('bet_result_notifications')}
                  />
                </div>

                <div className='flex items-center justify-between'>
                  <div className='space-y-0.5'>
                    <Label className='text-base font-medium' htmlFor='jackpot_notifications'>
                      <div className='flex items-center'>
                        <DollarSign className='mr-2 h-4 w-4 text-amber-500' />
                        Jackpot
                      </div>
                    </Label>
                    <p className='text-sm text-muted-foreground'>Thông báo về jackpot và giải thưởng lớn</p>
                  </div>
                  <Switch
                    id='jackpot_notifications'
                    checked={settings.jackpot_notifications}
                    onCheckedChange={() => handleToggle('jackpot_notifications')}
                  />
                </div>
              </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between'>
                  <div className='space-y-0.5'>
                    <Label className='text-base font-medium' htmlFor='referral_notifications'>
                      <div className='flex items-center'>
                        <Users className='mr-2 h-4 w-4 text-indigo-500' />
                        Giới thiệu
                      </div>
                    </Label>
                    <p className='text-sm text-muted-foreground'>Thông báo khi có người đăng ký qua link giới thiệu</p>
                  </div>
                  <Switch
                    id='referral_notifications'
                    checked={settings.referral_notifications}
                    onCheckedChange={() => handleToggle('referral_notifications')}
                  />
                </div>

                <div className='flex items-center justify-between'>
                  <div className='space-y-0.5'>
                    <Label className='text-base font-medium' htmlFor='account_notifications'>
                      <div className='flex items-center'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={() => handleToggle('account_notifications')}
                  />
                </div>
      ...
      <CardFooter className='border-t px-6 py-4'>
        <Button onClick={handleSaveSettings} disabled={updateMutation.isLoading} className='w-full'>
