...
import { Eye, EyeOff, Loader2, CheckCircle, AlertCircle, Shield, Lock } from 'lucide-react'
      ...
      <Card className='border-success/20 bg-success/5'>
        ...
        <CardContent className='space-y-4'>
          ...
          <Alert className='bg-success/10 border-success/30'>
            <AlertDescription>Bạn sẽ được chuyển hướng đến trang đăng nhập trong vài giây...</AlertDescription>
          </Alert>
        </CardContent>
